...
public:
   // Public definitions
   typedef int(*ProgressFnCallback)(void*, double, double, double, double);
   typedef void(*LogFnCallback)(const std::string&);
   ...
   inline ProgressFnCallback GetProgressFnCallback() const
   {
